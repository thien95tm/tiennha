        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 text-left text-gray-600">
            <tr>
              ...
              <th className="px-4 py-3 text-right">Điện/số</th>
              <th className="px-4 py-3">Bill gần nhất</th>
              <th className="px-4 py-3 text-right">Tổng tháng đó</th>
            </tr>
          </thead>
            ...
            {rooms.map(r => {
              ...
              return (
                <tr key={r.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-right">{vnd(r.rent_amount)}</td>
                  <td className="px-4 py-3 text-right">{vnd(r.water_fee)}</td>
                  <td className="px-4 py-3 text-right">{vnd(r.electric_unit_price)}</td>
                  <td className="px-4 py-3">
                    {b ? (
                      <div>
